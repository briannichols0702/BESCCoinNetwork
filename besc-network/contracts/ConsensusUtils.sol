...
contract ConsensusUtils is EternalStorage, ValidatorSet {
  ...
  uint256 public constant MIN_STAKE = 1e22; // 10,000
  uint256 public constant MAX_STAKE = 2e22; // 20,000
  uint256 public constant CYCLE_DURATION_BLOCKS = 17280; // 48 hours [48*60*60/10]
